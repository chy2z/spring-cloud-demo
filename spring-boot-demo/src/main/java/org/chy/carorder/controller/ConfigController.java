...
public class ConfigController {
    ...
    /**
     * 测试获取配置
     * http://localhost:8080/config/getConfig
     *
     * @return
     */
    @GetMapping("/getConfig")
    public ResponseEntityDTO<String> getConfig() {
        LOGGER.info("getConfig is requested");
        return ResponseEntityDTO.success("config");
    }
